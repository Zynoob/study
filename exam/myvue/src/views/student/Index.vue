    ...
    <Layout>
      <Header>
        <Menu mode="horizontal" theme="dark" active-name="1">
          ...
          <MenuItem name="2" to="/student/personinfo">
          ...
          <Layout>
            <Sider hide-trigger :style="{background: '#fff'}">
              <Menu theme="light" width="auto">
                <Submenu name="1">
                  <template slot="title">
                    <Icon type="ios-keypad"></Icon>考试
                  </template>
                  <MenuItem name="1-1" to="/student/choicepaper">选择考试</MenuItem>
                </Submenu>
                <Submenu name="2">
                  <template slot="title">
                    <Icon custom="iconfont icon-chaxun"/>查询
                  </template>
                  <MenuItem name="2-1" to="/student/myscore">查询成绩</MenuItem>
                </Submenu>
              </Menu>
            </Sider>
            <Content :style="{padding: '24px', minHeight: '280px', background: '#fff'}">
              <div v-if="$route.name == 'student'">这是学生页面</div>
