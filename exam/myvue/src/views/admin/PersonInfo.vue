            ...
            <Sider hide-trigger :style="{background: '#fff'}">
              <Menu theme="light" width="auto">
                <Submenu name="1">
                  ...
                  <MenuItem name="1-1" to="/admin/personinfo/baseinfo">基本信息</MenuItem>
                  <MenuItem name="1-2" to="/admin/personinfo/modifypwd">修改密码</MenuItem>
                </Submenu>
              </Menu>
            </Sider>
            <Content :style="{padding: '24px', minHeight: '280px', background: '#fff'}">
              <div v-if="$route.name == 'admin_personinfo'">这是个人信息页面</div>
              <keep-alive>
