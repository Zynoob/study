...
export default {
  ...
  methods: {
    ...
    submit(name) {
        ...
        case "单选题":
          {
            ...
            obj = Object.assign({}, obj, this.radioData, other1);
          }
          break;
        case "多选题":
          {
            ...
            obj = Object.assign({}, obj, this.multipleData, other2);
          }
          break;
        case "判断题":
          {
            ...
            obj = Object.assign({}, obj, this.judgeData, other3);
          }
          break;
      }
      ...
      this.$mypost("/api/admin/singleQuestion.php", {
        question: obj
      })
        .then(data => {
          // console.log(data);
